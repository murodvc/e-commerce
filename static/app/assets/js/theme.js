...
var kanbanInit = function kanbanInit() {
  var Selectors = {
    ...
    KANBAN_ITEMS_CONTAINER: '.kanban-items-container',
    BTN_ADD_CARD: '.btn-app-card',
    COLLAPSE: '.collapse',
    ADD_LIST_FORM: '#addListForm',
    BTN_COLLAPSE_DISMISS: '[data-dismiss="collapse"]',
    BTN_FORM_HIDE: '[data-btn-form="hide"]',
    INPUT_ADD_CARD: '[data-input="app-card"]',
    INPUT_ADD_LIST: '[data-input="app-list"]'
  };
  var ClassNames = {
    FORM_ADDED: 'form-added',
    D_NONE: 'd-none'
  ...
  var collapseDismissButtons = document.querySelectorAll(Selectors.BTN_COLLAPSE_DISMISS); // Show app card form and place scrollbar bottom of the list
  ...
  if (addListForm) {
    // Hide app list button when the form is going to show
  ...
  } // Hide app list form when the dismiss button is clicked
