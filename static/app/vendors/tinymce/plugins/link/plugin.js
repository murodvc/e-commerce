...
(function () {
    ...
    var tryEmailTransform = function (data) {
      ...
      return suggestMailTo ? Optional.some({
        message: 'The URL you entered seems to be an email address. Do you want to app the required mailto: prefix?',
    ...
    var tryProtocolTransform = function (assumeExternalTargets, defaultLinkProtocol) {
      return function (data) {
        ...
        return suggestProtocol ? Optional.some({
          message: 'The URL you entered seems to be an external link. Do you want to app the required ' + defaultLinkProtocol + ':// prefix?',
          preprocess: function (oldData) {
