...
// app fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
...
module.exports = Object.create || function create(O, Properties) {
  ...
  if (O !== null) {
    ...
    // app "__proto__" for Object.getPrototypeOf polyfill
    result[IE_PROTO] = O;
...
var Draggable = function () {
  ...
  (0, _createClass3.default)(Draggable, [{
     ...
     * @param {...HTMLElement} containers - Containers you want to app to draggable
     * @return {Draggable}
...
var fastKey = function (it, create) {
  ...
  if (!has(it, META)) {
    ...
    // not necessary to app metadata
    if (!create) return 'E';
    // app missing metadata
    setMeta(it);
  // return object ID
  } return it[META].i;
};
...
// app metadata on freeze-family methods calling
...
var Sensor = function () {
  ...
  (0, _createClass3.default)(Sensor, [{
     ...
     * @param {...HTMLElement} containers - Containers you want to app to this sensor
     * @example draggable.addContainer(document.body)
     */
