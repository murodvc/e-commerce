...
function copyRegex(regex, options) {
  ...
  if (!options.isInternalOnly) {
    ...
    } // null or undefined; don't want to app to `flags` if the previous value was null, since
 ...
 *   astral: true,
 *
 *   // Don't app named capture groups to the `groups` property of matches
 *   namespacing: true
 * });
 *
 * // With an options string
...
/*
  ...
  options.sham        - app a flag to not completely full polyfills
...
module.exports = function (options, source) {
  ...
  for (key in source) {
    ...
    // app a flag to not completely full polyfills
...
'use strict';
var toIndexedObject = require('../internals/to-indexed-object');
var addToUnscopables = require('../internals/app-to-unscopables');
var Iterators = require('../internals/iterators');
