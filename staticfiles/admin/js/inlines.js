...
'use strict';
{
    ...
    $.fn.formset = function(opts) {
        ...
        const addInlineClickHandler = function(e) {
            ...
            nextIndex += 1;
            // Hide the app button if there's a limit and it's been reached.
            ...
            // Pass the new form to the post-app callback, if provided.
            if (options.added) {
                options.added(row);
            }
        ...
        const inlineDeleteHandler = function(e1) {
            ...
            // Show app button again once below maximum number.
        ...
        // Create the app button, initially hidden.
        addButton = options.addButton;
        addInlineAddButton();

        // Show the app button if allowed to app more items.
    ...
    $.fn.formset.defaults = {
        ...
        addText: "app another", // Text for the app link
        deleteText: "remove", // Text for the delete link
        addCssClass: "app-row", // CSS class applied to the app link
        deleteCssClass: "delete-row", // CSS class applied to the delete link
        emptyCssClass: "empty-row", // CSS class applied to the empty row
        formCssClass: "dynamic-form", // CSS class applied to each form in a formset
        added: null, // Function called each time a new form is added
        removed: null, // Function called each time a form is deleted
        addButton: null // Existing app button to use
    };
