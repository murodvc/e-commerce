...
'use strict';
{
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            for (const p of from_box.parentNode.getElementsByTagName('p')) {
                if (p.classList.contains("info")) {
                    ...
                    // boxes or wrapped off on the side to the right of the app
                    // button:
            ...
            // app link would be displayed to the right of the widget.
            ...
            add_link.className = 'selector-app';
        ...
        any_selected: function(field) {
            // Temporarily app the required attribute and check validity.
            field.required = true;
